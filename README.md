...
- [guardian-agent-prompts](https://github.com/milkomida77/guardian-agent-prompts) - Multi-agent AI trading system with ICT/SMC strategy analysis, real-time signal generation, and risk management across 49 specialized Claude Code agents.
## LLMs
