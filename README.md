...
- [DexPaprika API](https://api.dexpaprika.com) - Free DEX and DeFi data API — real-time pool data, token prices, OHLCV, and trade history across 36 chains. No API key needed; free tier is 200K requests/month. Includes MCP server for AI agents.
