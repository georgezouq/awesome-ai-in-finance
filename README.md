...
- [DeepAlpha](https://github.com/stefanoviana/deepalpha) - AI crypto trading bot with 70.9% walk-forward validated accuracy. LightGBM + XGBoost ensemble with 72 ML features for Bybit perpetual futures.
