...
- [YIELD INTELLIGENCE](https://github.com/thebrierfox/intuitek-ace) - Passive income opportunity analysis MCP server with live US Treasury rates, portfolio yield calculator, and AI-powered income optimization. Open MCP endpoint at `https://api.intuitek.ai/yield/mcp` (no auth required).
