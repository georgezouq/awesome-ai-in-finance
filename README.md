...
- [ODEI](https://api.odei.ai) - Constitutional world model with smart contract security audit and financial agent guardrails. 7-layer validation before transactions. ERC-8004 on Base and BSC. [GitHub](https://github.com/odei-ai/web)
