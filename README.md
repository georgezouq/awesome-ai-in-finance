...
- [Registry Broker](https://github.com/hashgraph-online/registry-broker) - Universal AI agent index for discovering trading agents across Virtuals Protocol, NANDA, MCP, and other registries.
